...
export const DAYS = [
  {
    ...
    draft: false,
    message:
      "Starting a countdown for you feels a little unfair, because I'd happily spend all twenty-five days just telling you about the first one. But we have to begin somewhere, so: I love that you exist, and that I get to be the one counting.",
    word: 'Vorfreude',
  ...
  },
  {
    ...
    draft: false,
    message:
      "I wish, just once, you could borrow my eyes for five minutes and look at yourself the way I do. You would finally understand why everyone who loves you loves you the way they do — why I do. You carry something rare in you, and you carry it so quietly I don't think you've ever noticed it's there.",
    word: 'Diffident',
    phonetic: 'DIF-ih-dent',
    part: 'adjective',
    origin: 'Latin, diffidere — "to distrust (oneself)"',
    meaning: "Modest or shy, to the point of underestimating one's own worth.",
  },
  {
    day: 7,
    draft: false,
  ...
  },
  {
    ...
    draft: false,
    message:
      "You walk into every room as though it already belongs to you, and you make it look effortless. I admire that in you — the ease, the light, the way people gather around you without you ever having to ask. Every quality I wish I carried more of, I find already living in you. You are the joy and the sunlight of my life, the one person I have ever let see all of me. And sometimes, looking at you, I catch myself looking into a mirror — my own reflection looking back, a little more sure of itself than usual.",
    word: 'Effulgent',
